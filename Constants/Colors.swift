...
//  ChoiceFreedom
//
//  Created by Owais Raza on 8/7/18.
...
struct Colors {
    ...
    static let kindaPurple = UIColor(red:0.51, green:0.00, blue:0.43, alpha:1.0)
    static let kindaOrange = UIColor(red:0.95, green:0.36, blue:0.36, alpha:1.0)
    ...
    static let kindaOwaisBlue = UIColor(red:0.27, green:0.41, blue:0.59, alpha:1.0)
}
